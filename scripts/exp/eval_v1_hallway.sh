...
# Wired: repo-root eval_act.py --task hallway. Do not paste into eval_output/simple_hallway_n50/.
set -e
...
SEED="${SEED:-1}"
TASK="${TASK:-pact_place_corridor_v5}"
...
EVAL_TASK="${EVAL_TASK:-hallway}"
CAMERAS="${CAMERAS:-wrist_camera}"
