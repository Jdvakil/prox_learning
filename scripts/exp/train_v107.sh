#!/usr/bin/env bash
# ./scripts/exp/train_v107.sh
# v107: pact_place_corridor/data/v107 (V10.7 asymmetric pendant + V9.5 clutter; small set). No closed-loop evaluator.
set -e
