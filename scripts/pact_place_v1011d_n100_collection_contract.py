#!/usr/bin/env python3
"""100-success V10.11d collection contract (batman). Failed rows are retained."""
...
CONTRACT_VERSION = "pact_place_v1011d_collection_100_v1"
...
SMOKE_STREAM = "pact_place_v1011d_collection_100_smoke"
SMOKE_MASTER_SEED = 2026101146
...
IMPLEMENTATION_PATHS = (
    "scripts/pact_place_v1011d_n100_collection_contract.py",
    "scripts/run_pact_place_v1011d_n100_collect.py",
    ...
    row.update(
        {
            ...
            "pact_v1011d_retain_failed_rows": True,
