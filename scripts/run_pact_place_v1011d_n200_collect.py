#!/usr/bin/env python3
"""Continue V10.11d collection from the stopped n100 ledger to 200 accepted."""
...
import pact_place_v1011d_n200_collection_contract as contract  # noqa: E402
...
SMOKE_COLLECTION_ROOT = ROOT / "diagnostics_output/pact_place_v1011d_n200_smoke"
SMOKE_DATASET_ROOT = ROOT / "output/pact_place_corridor_v10_11d_n200_smoke"
...
def main() -> int:
    ...
    submit_index = 0
    print(
        f"V10.11d n200: {sum(accepted.values())}/{contract.TARGET_SUCCESSES} "
    ...
    closeout = {
        **empty_authorization(),
        "schema_version": "pact_place_v1011d_collection_200_closeout_v1",
        "contract_version": contract.CONTRACT_VERSION,
