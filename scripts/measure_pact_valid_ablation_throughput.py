#!/usr/bin/env python3
"""Record outcome-blind valid-ablation throughput over 20 minutes."""
...
def main() -> int:
    ...
    rate = len(completions) / args.measurement_minutes
    remaining = max(0, TOTAL_ROWS - len(ledger["completions"]))
    artifact = {
        "schema_version": "pact_valid_ablation_throughput_v1",
        ...
        "completed_rows": len(completions),
        ...
        "projected_remaining_hours": (
            remaining / rate / 60 if rate else None
        ),
