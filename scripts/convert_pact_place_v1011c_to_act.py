...
Derived from the V10.9 converter; all source and historical artifacts are read-only.
"""
...
def convert_one(task: tuple[dict[str, Any], str]) -> dict[str, Any]:
    ...
    try:
        with h5py.File(temporary, "w") as output:
            ...
            output.attrs["pact_source_version"] = "pact_place_v10_11c_owner_requested"
...
def main() -> int:
    ...
    document: dict[str, Any] = {
        **empty_authorization(),
        "schema_version": "pact_place_v1011c_conversion_manifest_v1",
        "contract_version": "pact_place_v1011c_train_eval_v1",
        "role": "fresh ACT-format conversion of the 99 accepted V10.11c demonstrations",
        "roles": ["v1011c_accepted_99"],
