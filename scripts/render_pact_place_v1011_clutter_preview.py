#!/usr/bin/env python3
"""Render a development-only V10.11 tabletop-clutter preview; no rollout."""
...
from pact_place_v1010_contract import build_row, sha256_payload  # noqa: E402

SCENE = ROOT / "custom_scenes" / "pact_place_corridor_v10_11_center_preview.xml"
OUTPUT = ROOT / "diagnostics_output/pact_place_v1011_clutter_preview"
...
def main() -> int:
    ...
    from run_pact_place_v6c_replay_videos import THIRD_PERSON_FOV, third_person_pose
    ...
    row["environment_version"] = "pact_place_corridor_v10_11_clutter_preview"
    ...
    try:
        ...
        if args.viewer:
            ...
            print(
                json.dumps(
                    {
                        "viewer": "one bottle toward robot",
