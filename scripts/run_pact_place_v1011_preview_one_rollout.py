#!/usr/bin/env python3
"""One diagnostic expert rollout on the V10.11 clutter preview. Not a gate."""
...
OUTPUT = ROOT / "diagnostics_output/pact_place_v1011_clutter_preview/one_rollout"
FRAME_STRIDE = 5
VIDEO_FPS = 10
...
def main() -> int:
    ...
    try:
        ...
        result = {
            "schema_version": "pact_place_v1011_preview_one_rollout_v1",
