#!/usr/bin/env python3
"""Launch the blind-RGB supervisor with setsid/nohup."""
...
def main() -> int:
    ...
    receipt = {
        "schema_version": "pact_blind_rgb_launcher_receipt_v1",
        ...
        "stdin_detached": True,
        "thread_limits": {"OMP_NUM_THREADS": "1", "MKL_NUM_THREADS": "1", "OPENBLAS_NUM_THREADS": "1"},
    }
