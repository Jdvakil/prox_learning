#!/usr/bin/env python3
"""Mac inspect / batman collect contract for V10.11d randomized clutter.

Not the frozen V10.11c 100-row quota. Six inspect cells, hybrid tablecam schema.
"""
...
CONTRACT_VERSION = "pact_place_v1011d_collection_100_from_mac_inspect_v1"
...
MIN_FREE_GIB = 40.0
DEFAULT_WORKERS = 1 if sys.platform == "darwin" else 6
DEFAULT_GPUS = 2

COLLECTION_ROOT = "diagnostics_output/pact_place_v1011d_n100"
...
IMPLEMENTATION_PATHS = (
    "scripts/pact_place_v1011d_collection_contract.py",
    "scripts/run_pact_place_v1011d_collect.py",
