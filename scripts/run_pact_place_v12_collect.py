#!/usr/bin/env python3
"""Collect the v12 place-corridor environment.

Planner: PactPlaceCorridorPolicy (via _make_config).
Sampler: PactPlaceCorridorV1010FourObjectSampler.
Household: park Soap_Bottle_30 / candles; keep Soap_Bottle_11 toward the robot;
standing kitchen extras stay out of the motion lane. Place is hover-then-drop.

Checkout add/pact-place-v12 from main, init the molmospaces submodule,
then run this script. Collected rows are not part of the branch.
"""
...
from pact_place_v12_contract import (  # noqa: E402
...
from run_pact_place_v12_one_rollout import (  # noqa: E402
    _install_preview_layout,
    _keep_glass_inside_blue_tray,
    _pin_runtime,
)
from run_pact_place_v12_publish import (  # noqa: E402
    prune_failed,
    row_defects,
    validate_trainable,
    _publish_episode,
...
DATASET_REL = "output/pact_place_corridor_v12"
COLLECTION_REL = "output/collection_v12"
TARGET_SUCCESSES = 3
REQUIRED_VIDEOS = (
...
def build_preview_row(family: str, side: str, pose: str, attempt_index: int) -> dict[str, Any]:
    ...
    row["household_layout"] = "soap_bottle_11_toward_robot"
...
def run_attempt(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    from run_pact_place_v12_expert import (
        _make_config,
    ...
    result.update({
        ...
        "schema_version": "pact_place_v12_v1",
    })
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Parallel attempts. Stripe workers across GPUs when available.",
    )
    parser.add_argument(
        "--gpus",
        type=int,
    ...
    closeout = {
        **empty_authorization(),
        "schema_version": "pact_place_v12_closeout_v1",
        "role": "development_preview_not_a_gate",
        "authorizes_collection": False,
        "environment_version": "pact_place_corridor_v12",
        "household_layout": "soap_bottle_11_toward_robot",
