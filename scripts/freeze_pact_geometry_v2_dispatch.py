#!/usr/bin/env python3
"""Freeze models, runtime, analysis, and attempt-2 durable dispatch."""
...
from pact_geometry_generalization_v2_main_contract import sha256_file, sha256_payload
...
def main() -> int:
    ...
    if (
        schedule.get("schema_version") != "pact_geometry_generalization_v2_schedule"
        ...
        raise ValueError("attempt-2 geometry schedule bindings changed")
    ...
    if output_root.exists() and any(output_root.iterdir()):
        raise ValueError("attempt-2 geometry evaluation output root is not empty")
    ...
    runtime_paths = {
        ...
        "manifest_builder": ROOT / "scripts/build_pact_geometry_v2_manifest.py",
    ...
    document: dict[str, Any] = {
        "schema_version": "pact_geometry_generalization_v2_dispatch",
        "scientific_schedule": {
