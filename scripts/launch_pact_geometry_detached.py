#!/usr/bin/env python3
"""Launch the geometry supervisor with setsid/nohup and detached stdin."""
...
SUPERVISOR = ROOT / "scripts/run_pact_geometry_supervisor.py"
...
def main() -> int:
    ...
    receipt = {
        "schema_version": "pact_geometry_generalization_launcher_receipt_v1",
        ...
        "stdin_detached": True,
        "environment": {key: environment[key] for key in ("MUJOCO_GL", "PYOPENGL_PLATFORM", "PYTHONUNBUFFERED", "MLSPACES_ASSETS_DIR", "PYTHONPATH")},
    }
