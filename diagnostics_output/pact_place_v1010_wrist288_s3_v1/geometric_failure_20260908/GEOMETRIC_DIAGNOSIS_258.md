...
Generated 2026-09-08T01:02:34.356079+00:00. Source snapshot: 258 validated rollouts,
comprising 29 paired cases for seed 3103 and 50 paired cases each for 3104 and 3105.
Seed 3103 is provisional; its remaining evaluation continues unchanged.
...
| PACT outcome | Seed 3104, n=50 | Seed 3105, n=50 | Seed 3103, n=29 |
|---|---:|---:|---:|
| Final task success | 19/50 | 35/50 | 12/29 |
| Any target touch | 43/50 | 47/50 | 25/29 |
| Any contact-only hold | 24/50 | 37/50 | 15/29 |
| Cup lifted at least 1 cm | 23/50 | 38/50 | 16/29 |
| Any tray support | 20/50 | 35/50 | 12/29 |
| Collision-free task success | 10/50 | 25/50 | 10/29 |

| Mutually exclusive final outcome | 3104 | 3105 | 3103 |
|---|---:|---:|---:|
| success | 19 | 35 | 12 |
| no target interaction | 7 | 3 | 4 |
| touched without hold | 18 | 8 | 8 |
| held without lift | 2 | 1 | 1 |
| lifted without placement | 3 | 3 | 4 |
...
![Commanded and actual trajectories, cup-wall footprints, and lift](representative_trajectories_258.png)
...
![All-case grasp geometry and initial target positions](geometry_overview_258.png)

## Does seed 3103 have this issue?

**Yes, the failure mode is present.** In the 29 currently included pairs,
PACT has 8 touch-without-hold failures;
4 satisfy the achieved-height description,
and 5 episodes satisfy the stricter blocked-descent signature.
Its task result in this snapshot is **12/29**, versus
**13/29** for ACT.
...
Reproduction: run `extract.py`, then `augment.py features_258.json`,
`contact_modes.py geometry_258.json`, `command_geometry.py geometry_258.json`,
`summarize.py 258`, and `write_report.py 258` in this directory with
