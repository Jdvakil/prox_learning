...
def run(args):
    ...
    start=original_training.validate_bundle(bundle,read(W/'config.json')['config_sha256'])
    ...
    def save(value,path):
        ...
        value['wrist288_config_sha256']=read(W/'config.json')['config_sha256']
    ...
    end=original_training.validate_bundle(completed,read(W/'config.json')['config_sha256'])
