...
Completed new rollouts: 12/1056 maximum main path. Final comparison: 0/600.
...
```json
{
  ...
  "resolution": "Exact trace or explicitly checked raster-onset diagnosis; originals remain separate. No full-trajectory identity or aggregation-causality claim.",
...
```json
{
  ...
  "resolution": "Action/outcome mismatch requires separate diagnosis; intervention blocked.",
  "schema": "pact_v1010b_grasp_v1"
}
```
